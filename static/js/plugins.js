...
!function (e, t) {
    ...
    var n = function (o, s) {
        function r(t, n) {
            if (t) if (t.resizedAttached) t.resizedAttached.add(n); else {
                ...
                var r = window.getComputedStyle(t), d = r ? r.getPropertyValue("position") : null;
                "absolute" !== d && "relative" !== d && "fixed" !== d && (t.style.position = "relative");
                var c, f, h = t.resizeSensor.childNodes[0], a = h.childNodes[0], l = t.resizeSensor.childNodes[1],
                    u = i(t), v = u.width, p = u.height, z = !0, w = 0, g = function () {
                        if (z) {
    ...
    if (n.reset = function (e) {
        ...
        var o = new MutationObserver(function (e) {
            for (var t in e) if (e.hasOwnProperty(t)) for (var i = e[t].addedNodes, o = 0; o < i.length; o++) i[o].resizeSensor && n.reset(i[o])
        });
